...
- ``find_isbns.py`` tries to find `valid ISBNs`_ inside a file or in a ``string`` if no file was 
  ...
  - `search_file_for_isbns() from lib.py`_ (Python function where ISBNs search is implemented).
...
.. _search_file_for_isbns() from lib.py: https://github.com/raul23/py-ebooktools/blob/0a3f7ceb5fb3e77a480a489d1a43d3346521e685/py_ebooktools/lib.py#L555
